...
<form action="{{route('products.store')}}" enctype="multipart/form-data" method="POST">
    ...
    <div class="row g-3 mb-5">
        ...
        <div class="col">
            ...
            <input type="number" class="form-control border border-black border-1 focus-ring" style="--bs-focus-ring-color: rgba(250, 61, 59, 0.25)" placeholder="Cantidad" aria-label="quantity" name="quantity" id="quantity" required>
        </div>
    </div>
    <div class="row g-3">
        <div class="col">
